...
class Client final : public WebhookActor::Callback {
 ...
 private:
  ...
  struct FileStreamRef {
    td::int64 id;
    td::ActorId<FileStreamConnection> actor;
  };
  td::FlatHashMap<int32, td::vector<FileStreamRef>> file_stream_listeners_;
  td::FlatHashMap<td::int64, td::ActorId<FileStreamConnection>> active_file_streams_;
